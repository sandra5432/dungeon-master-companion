...
-- ── Users ────────────────────────────────────────────────────────────────────
INSERT INTO users (username, password, created_at) VALUES ('admin', '$2a$12$vAhZblQKZukKDkYGp8IIuOpnnS7naC6ZvWDpz.AhRQp28w0GX4u1.', CURRENT_TIMESTAMP);
...
-- ── Creators ─────────────────────────────────────────────────────────────────
INSERT INTO creators (code, full_name, color_hex, created_at) VALUES ('AL', 'Anna L.', '#9a4aaa', CURRENT_TIMESTAMP);
INSERT INTO creators (code, full_name, color_hex, created_at) VALUES ('MM', 'Max M.', '#2a9a68', CURRENT_TIMESTAMP);
INSERT INTO creators (code, full_name, color_hex, created_at) VALUES ('RV', 'Ralf V.', '#bf603a', CURRENT_TIMESTAMP);
INSERT INTO creators (code, full_name, color_hex, created_at) VALUES ('SK', 'Sven K.', '#3a7abf', CURRENT_TIMESTAMP);
...
INSERT INTO timeline_events (world_id, title, sequence_order, date_label, type, description, creator_code, created_at, updated_at)
VALUES (1, 'Ankunft der Erbauer', 1.0, 'Vor langer Zeit', 'WORLD',
  ...
  'AL', CURRENT_TIMESTAMP, CURRENT_TIMESTAMP);
